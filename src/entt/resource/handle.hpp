...
public:
    ...
    /**
     * @brief Gets a mutable reference to the managed resource.
     *
     * @warning
     * The behavior is undefined if the handle doesn't contain a resource.<br/>
     * An assertion will abort the execution at runtime in debug mode if the
     * handle is empty.
     *
     * @return A mutable reference to the managed resource.
     */
    ...
    /**
     * @brief Casts a handle and gets a mutable reference to the managed resource.
     *
     * @warning
     * The behavior is undefined if the handle doesn't contain a resource.<br/>
     * An assertion will abort the execution at runtime in debug mode if the
    ...
    /**
     * @brief Gets a mutable pointer to the managed resource from a handle.
     *
     * @warning
     * The behavior is undefined if the handle doesn't contain a resource.<br/>
     * An assertion will abort the execution at runtime in debug mode if the
     * handle is empty.
     *
     * @return A mutable pointer to the managed resource or `nullptr` if the handle
     * contains no resource at all.
     */
