...
TEST(SingleComponentView, DeductionGuide) {
    entt::registry registry;
    typename entt::storage_traits<entt::entity, int>::type istorage;
    typename entt::storage_traits<entt::entity, stable_type>::type sstorage;
...
TEST(SingleComponentView, Storage) {
    ...
    static_assert(std::is_same_v<decltype(view.storage()), typename entt::storage_traits<entt::entity, int>::type &>);
    static_assert(std::is_same_v<decltype(view.storage<0u>()), typename entt::storage_traits<entt::entity, int>::type &>);
    static_assert(std::is_same_v<decltype(view.storage<int>()), typename entt::storage_traits<entt::entity, int>::type &>);
    static_assert(std::is_same_v<decltype(cview.storage()), const typename entt::storage_traits<entt::entity, char>::type &>);
    static_assert(std::is_same_v<decltype(cview.storage<0u>()), const typename entt::storage_traits<entt::entity, char>::type &>);
    static_assert(std::is_same_v<decltype(cview.storage<const char>()), const typename entt::storage_traits<entt::entity, char>::type &>);
...
TEST(MultiComponentView, DeductionGuide) {
    entt::registry registry;
    typename entt::storage_traits<entt::entity, int>::type istorage;
    typename entt::storage_traits<entt::entity, double>::type dstorage;
    typename entt::storage_traits<entt::entity, stable_type>::type sstorage;
...
TEST(MultiComponentView, SameComponentTypes) {
    entt::registry registry;
    typename entt::storage_traits<entt::entity, int>::type storage;
    typename entt::storage_traits<entt::entity, int>::type other;
...
TEST(MultiComponentView, Storage) {
    ...
    static_assert(std::is_same_v<decltype(view.storage<0u>()), typename entt::storage_traits<entt::entity, int>::type &>);
    static_assert(std::is_same_v<decltype(view.storage<int>()), typename entt::storage_traits<entt::entity, int>::type &>);
    static_assert(std::is_same_v<decltype(view.storage<1u>()), const typename entt::storage_traits<entt::entity, char>::type &>);
    static_assert(std::is_same_v<decltype(view.storage<const char>()), const typename entt::storage_traits<entt::entity, char>::type &>);
